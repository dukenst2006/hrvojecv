			...
			<div class="col-lg-6">
				<div class="alert alert-info" id="accessResponseAlert">
					<p>
						...
						You may now close this window and check you inbox (and spam folder) and follow instructions. <br> <br>
						Regards, <br>
						Hrvoje Zubcic
					</p>
				</div>
			...
			<div class="col-lg-6">
				<div class="alert alert-danger" id="accessResponseAlert">
					<p>
						...
						Please, <a href="mailto:hrcamnlz@gmail.com?subject=Access Request Error">contact me</a> so that I can handle it as soon as possible. <br> <br>
						Regards, <br>
						Hrvoje Zubcic
					</p>
				</div>
